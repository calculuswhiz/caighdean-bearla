...
:Table5C-Note_en: The independent verb is lenited in the indicative mood, past tense (other than the autonomous verb) and past habitual tense, and in the conditional mood. There is more information in link:./chapter10-en.html#sec_10_4[10.4] about the other contexts in which the dependent and independent verb is lenited and the contexts in which the verb is eclipsed are discussed in link:./chapter10-en.html#sec_10_8[10.8].
...
:Table5CC-trait-3_en: As a noun in the Third Declension, where a suffix is added to the base noun, e.g., _bádóir_, _bádóireacht_; _peata_, _peataireacht_ and for other verbal nouns (see link:./chapter2-en.html#sec_2_4_2[2.4.2])
