...
<table class="chapter-1">
  <caption>
    <strong>{Table} 1J</strong> {AnTuisealTabharthachUatha} &mdash; {Table1J-header}
  </caption>
  <colgroup>
    <col class="w-1/2">
    <col class="w-1/2">
...
<table class="chapter-1">
  <caption>
    <strong>{Table} 1K</strong> {AnTuisealTabharthachUatha} &mdash; {Table1K-header}
  </caption>
  <colgroup>
    <col class="w-1/2">
    <col class="w-1/2">
...
<table class="chapter-1">
  <caption>
    <strong>{Table} 1L</strong> {AnTuisealTabharthachUatha} &mdash; {Table1L-header}
  </caption>
  <colgroup>
    <col class="w-1/2">
    <col class="w-1/2">
...
<table class="chapter-1">
  <caption>
    <strong>{Table} 1M</strong> {AnTuisealTabharthachUatha} &mdash; {Table1M-header}
  </caption>
  <colgroup>
    <col class="w-1/2">
    <col class="w-1/2">
