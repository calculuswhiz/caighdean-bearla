...
:3-1-1-p_en: A noun is either definite or indefinite. A definite noun is a noun that refers to a definite person or thing. A definite person or thing is referred to in one of the ways shown in 3.1.2 below. Any other noun is an indefinite noun.
...
:3-3-3-p_en: A verbal noun is a word that has both the function of a noun and a verb. It is possible to use words like _eitilt_, _foghlaim_, _snámh_, etc. like nouns, e.g., _deireadh na heitilte_; _foghlaim a fháil_; _snámh féileacáin_, and as a verbal noun, e.g., _ag eitilt sa spéir_; _ag foghlaim teanga_; _ag snámh in aghaidh easa_. This accounts for cases where the nominative form is used instead of the genitive form.

:3-3-3-a-p_ga: Ní dhéantar athrú an ghinidigh ar ainm briathartha nuair atá an forainmneach réamhthagrach _a_ roimhe.
:3-3-3-a-p_en: The genitive case of a verbal noun is not changed when preceded by the prepositional pronoun _a_.
...
:3-3-3-b-p1_en: If there is a verbal noun in the structure _chun_ + _ainm briathartha_ used to express an upcoming action, the genitive case is not changed.
...
:3-3-4-a-p1_en: If an indefinite noun has a normal genitive following one of the declensions (see 5.6.1) also used as a verbal noun, the genitive case is not changed when it is used as a verbal noun.

:3-3-4-a-p2_ga: *Ach*, déantar athrú an ghinidigh ar an ainmfhocal nuair a úsáidtear mar ainmfhocal éiginnte é.
:3-3-4-a-p2_en: *But*, the genitive case of a noun is changed when it is used as an indefinite noun.
...
:3-3-4-b-p1_en: If an indefinite noun that is also used as a verbal noun does not have a normal genitive according to one of the declensions (see 5.6.1(a)), and if it is the direct object of a verbal noun preceded by _ag_ or _do_ (or _a_ from _do_), the genitive is not changed.

:3-3-4-b-p2_ga: *Ach*, nuair atá an t-ainmfhocal cinnte, déantar athrú an ghinidigh air.
:3-3-4-b-p2_en: *But*, when it is the definite noun, the genitive is changed.
...
:3-3-4-c-p1_en: If an indefinite noun that is also used as a verbal noun does not have a normal genitive according to one of the declensions (see 5.6.1(a)), and if it is subject to a compound preposition or follows _chun_, the genitive is not changed.

:3-3-4-c-p2_ga: *Ach*, nuair atá an t-ainmfhocal cinnte, déantar athrú an ghinidigh air.
:3-3-4-c-p2_en: *But*, when it is the definite noun, the genitive is changed.
...
:3-3-7-p1_en: If an indefinite noun that is subject to a noun expressing definite quantity is presented in a recipe or in the form of a list, the genitive case of the noun or adjective being qualified is not changed.
...
:3-3-8-a-p_en: The genitive case of an indefinite noun that is subject to a verbal noun preceded by _ag_ or _do_ (or _a_ from _do_), subject to compound preposition or subject to an indefinite quantity is not changed if the indefinite noun is qualified by one of the qualifiers listed in tables 3B, 3C and 3D below.
...
:3-3-8-b-p_en: The indefinite noun itself must be qualified with the qualifier to cancel the genitive. If the qualifier functions as something other than an adjective (as an adverb, for example), the indefinite noun is changed to the genitive case (see 3.3.12(b)).
...
:3-3-9-p_en: When an indefinite noun is subject to a verbal noun preceded by _ag_ or _do_ (or _a_ from _do_) qualified with the qualifiers listed below, the indefinite noun is not changed in the genitive (or the accompanying adjective).
...
:3-3-10-p1_en: When an indefinite noun that is subject to a compound preposition (or _cois_, _dála_, _fearacht_, _timpeall_, _trasna_) qualified with one of the qualifiers shown below, the genitive of the indefinite noun is not changed (or the adjective accompanying it).
...
:Table3C-Row3_en: Prepositional dependent clause, e.g., _ar an mBille_, _faoin mbord_, _sa phóstaer_, etc., or prepositional pronoun, e.g., _air_, _fúithi_, _uainn_, etc., if it has a adjectival function
...
:3-3-10-p2_en: Note that a prepositional phrase that has a compound preposition with a specific meaning, e.g., _i gcás_ meaning _más rud é_ (_if_). _Simple preposition + noun_ is the model for this. Table 3C does not apply if an indefinite noun is present that is subject to a preposition and a noun that is not a compound preposition, e.g., _i gcas_ meaning _in imeachtaí dlí_ (in a legal proceeding), _i mála_ (in a bag).
...
:3-3-11-p1_en: When an indefinite noun is subject to a word or phrase expressing an indefinite quantity, e.g., _barraíocht_, _breis_, _easpa_, _go leor_, _iomarca_, _níos mó_, _roinnt_, qualified with one a qualifier in the below table, the genitive of the indefinite noun is not changed (or the adjective accompanying it).
...
:3-3-11-p2_en: Note that an indefinite quantity is observed as a definite quantity when a possessive adjective preceds it and in this case the genitive of the following noun is changed (and the adjective accompanying it), e.g., _a chuid gruaige fada_; _a dóthain bia the_; _a ndóthain saineolais theicniúil_; _ár gcuid oibre baile_.
...
:3-3-12-a-p_en: Apart from the cases specified in tables 3B, 3C and 3D, the genitive of the indefinite noun is changed in the structure _noun_ + _indefinite noun_ + _qualifier_.
...
:3-3-12-b-p_en: The genitive is changed for an indefinite noun is subject to a compound preposition and followed by a prepositional phrase, prepositional phrase or prepositional pronoun unless the indefinite noun is qualified by that prepositional phrase, prepositional dependent clause or prepositional pronoun (for example, if the verb rather than the indefinite noun is qualified) or by any of the other qualifier mentioned in table 3C.
...
:Table3G-row1-condition_en: A noun that comes before a definite noun in the genitive (3.3.1(a))

:Table3G-row1-rule_ga: Focal nó leagan a leanann an ginideach é
:Table3G-row1-rule_en: Word or form following the genitive

:Table3G-row2-condition_ga: Aonad cinnte áirithe a bhfuil ainm briathartha ina dhlúthchuid de (3.3.1(b))
:Table3G-row2-condition_en: A certain definite unit of which a verbal noun is an integral part (3.3.1(b))
...
:Table3G-row3-condition_en: A noun or noun phrase, definite or indefinite, connected by a preposition _a_ (from _do_) to a verbal noun (3.3.2(a))
...
:Table3G-row4-condition_en: _cuid_ and _ceann_, and genitive partitive or dative partitive subject to it (3.3.2(b))
...
:Table3G-row5-condition_en: A single common noun without the article that is used as the name of a company, association or program (3.3.2(c))
...
:Table3G-row6-condition_en: A verbal noun that is preceded by the proleptic pronoun _a_ (3.3.3(a))
...
:Table3G-row7-condition_en: A verbal noun (3.3.3(b))
...
:Table3G-row8-condition_en: A certain indefinite unit has a verbal noun as an integral part (3.3.3(c))
...
:Table3G-row9-condition_en: An indefinite noun is used as a verbal noun also, and has a normal genitive subject to one of the declensions, that is used as a verbal noun (3.3.4(a))
...
:Table3G-row10-condition_en: An indefinite noun is used as a verbal noun also, and does not have a normal genitive subject to one of the declensions, that is the direct object of a verbal noun (3.3.4(b))
...
:Table3G-row11-condition_en: An indefinite noun that is used as a verbal noun also, and does not have a normal genitive subject to one of the declensions (3.3.4(c))
...
:Table3G-row12-condition_en: An indefinite noun in a verbal noun clause that cannot function independently without a simple preposition or prepositional clause following it (3.3.5)
...
:Table3G-row13-condition_en: The first indefinite noun in a multi-word phrase that has a specific meaning (3.3.6(a)) 
...
:Table3G-row14-condition_en: _tús_, _lár_ or _deireadh_, if they are the first noun in a unit of two indefinite nouns (3.3.6(b))
...
:Table3G-row15-condition_en: A noun in a list (3.3.7)
...
:Table3G-row16-condition_en: An indefinite noun qualified by a certain qualifier (3.3.9)
...
:Table3G-row17-condition_en: An indefinite noun qualified by a certain qualifier (3.3.10)
...
:Table3G-row18-condition_en: An indefinite noun qualified by a certain qualifier (3.3.11)
