...
<table class="chapter-4">
  <caption>
    <strong>{Table} 4B</strong>  {Table4B-caption}
  </caption>
  <thead>
    <tr>
...
<table class="chapter-4">
  <caption>
    <strong>{Table} 4D</strong>  {Table4D-caption}
  </caption>
  <thead>
    <tr>
      <th colspan="4">{Table4D-title}</th>
    </tr>
    <tr>
      <th>{Table4D-col1}</th>
      <th>{Table4D-col2}</th>
...
<table class="chapter-4">
  <caption>
    <strong>{Table} 4E</strong> {Table4E-caption}
  </caption>
  <thead>
    <tr>
      <th colspan="4">{Table4E-title}</th>
    </tr>
    <tr>
      <th>{Table4D-col1}</th>
      <th>{Table4D-col2}</th>
...
<table class="chapter-4">
  <caption>
    <strong>{Table} 4F</strong> {Table4F-caption}
  </caption>
  <thead>
    <tr>
      <th colspan="4">{Table4F-title}</th>
    </tr>
    <tr>
      <th>{Table4D-col1}</th>
      <th>{Table4D-col2}</th>
...
<table class="chapter-4">
  <caption>
    <strong>{Table} 4G</strong> {Table4G-caption}
  </caption>
  <thead>
    <tr>
      <th colspan="4">{Table4G-title}</th>
    </tr>
    <tr>
      <th>{Table4D-col1}</th>
      <th>{Table4D-col2}</th>
