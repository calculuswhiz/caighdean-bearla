...
:IndicativeMood_en: The Indicative Mood
...
:5-1-2-b-p_en: verbs of monosyllabic roots ending in _áil_, e.g., _sábháil_, _tarrtháil_, and some particular polysyllabic verbs, e.g., _adhlaic_, _ceiliúir_, _gearán_, _seachaid_, _taispeáin_, _tíolaic_.
...
:5-1-7-p_en: The independent form is the form of the verb used in an affirmative declarative principal clause, e.g., _bhí mé_; _ceannóidh sé_; _mholfadh sí_. Unless otherwise stated, it is the independent form that is given in the conjugations in the rest of this chapter, except in the Present Subjunctive Mood.
...
:5-1-8-p_en: The dependent form follows these conjunctions, relative pronominals and verbs: _a/ar_ (= the relative clause), _a/ar_ (= _an méid a/ar_), _an/ar_, _cá/cár_, _dá/dár_, (_de_ or _do_ + _a_ (_ar_)) and _dá_ (conditional), _go/gur_, _mura/murar_, _nach/nár_, _ní/níor_, _sula/sular_ (see 10.4.2 and 10.8.2).
...
:5-4-5-p_en: The dependent form follows these conjunctions, relative pronominals and verbs: _a/ar_ (= the relative clause), _a/ar_ (= _an méid a/ar_), _an/ar_, _cá/cár_, _dá/dár_ (_de_ or _do+a_ (_ar_)) and _dá_ (conditional), _go/gur_, _mura/murar_, _nach/nár_, _ní/níor_, _sula/sular_ (see 10.4.2 and 10.8.2). The dependent form in the tables is represented by _ní_ or _go_.
